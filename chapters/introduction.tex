...
\end{subfigure}
\caption{Twelve of the ninety different possible rewirings of a triangle graph in the configuration model.}
...
As a matter of example, in the ring of clique graph, penalty in Modularity for merging a pair of adjacent cliques in the ring of cliques graph shown in Figure~\ref{fig:traag_ring_of_cliques}, is given by:
...
This powerful argument against an improper use of Modularity, can be also cast in visual terms. We sampled the configuration space of the partitions of a ring of clique network through a Montecarlo procedure and annotated its corresponding values of quality function for each partition.
