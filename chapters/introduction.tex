...
\begin{figure}
\includegraphics[width=1.0\textwidth]{images/nrn3901-f5.jpg}
\caption{The relation between modules and hubs in the brain is depicted in a. where the possibility of overlapping modules is taken in consideration.}
\end{figure}
