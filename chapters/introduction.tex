...
Degeneracy (or redundancy) is also important when evaluating the consequences of brain lesions. A poorer prognosis is registered when the interested area of the insult has low degeneracy, i.e. only that area is deputed to a particular region such that no other area may compensate. Additionally a severe impairment of neurocognitive functions is associated with damage to highly central nodes, as shown in Figure~\ref{fig:prognosis_centrality}.

\begin{figure}[htb!]
\centering
\includegraphics[width=1\textwidth]{images/prognosis.pdf}
...
\includegraphics[height=0.35\textwidth]{images/guimera_amaral_coact_q.pdf}
...
\centering
\includegraphics[height=0.35\textwidth]{images/hubs_nonhubs.pdf}
...
The \emph{Normalized Mutual Information} \cite{danon2005} and the \emph{Variation of Information}\cite{meila2007} are the most widely used, despite it has been recently found that both of them suffer of systematic errors due to the finite size of the network \cite{zhang2015}. In the rest of the discussions we ignore the limitation of finite size effects, by only working with relatively large networks.
