...
Like for Modularity, any other quality function afflicted from the degeneracy problem, displays a landscape with a plateau of optimal partitions, like the one shown in Figure~\ref{fig:degeneracylandscape}, whereas in the case of non-degenerate quality functions, a sharp and distinct peak exists in the embedded landscape.\todo{HO FIXATO QUESTA FRASE VEDERE SE VA BENE}
