...
Among the many advantages of a modular organization of the brain, two are of greatest importance.

Firstly, the organization of a system into many compartments devoted to different functions is evolutionarily favored.
...
By way of example, in the field of robotics, spontaneous structural modularity of neural networks controllers emerge from evolutionary optimization when successful robot behavior is encoded as fitness function~\cite{bongard2011}.

The second benefit of modular brain networks resides in the increased resilience to sudden external perturbations.
Local disruptive modification may only affect one module, whereas the others are preserved from the insult. In case of externally or internally generated fluctuations, a modular architecture prevents functional disruption of the network leading to the possible death of the organism.
...
Since its reconstruction, many studies have investigated it with graph-theoretical methods, in order to unveil its properties.
The modular structure of this simple yet informative structural connectome has been consistently observed with a variety of methods and linked its function~\cite{sporns2016}.
Many of the worm operations (movements, mating and eating reflexes) are indeed linked to distinct subgroups of neurons, functionally cooperating for the success of these activities.

Further, meta-analytic studies of both the cat~\cite{scannell1995}, macaque~\cite{felleman1991} and rodents~\cite{schwarz2008} suggest that cortico-cortical networks of these more evolved animals are modular with a limited number of (typically four) prominent clusters corresponding to the main functional division of the cortex: visual, auditory, fronto-limbic and somatosensory. 
