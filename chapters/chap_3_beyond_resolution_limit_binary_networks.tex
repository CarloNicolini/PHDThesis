...
The spin-glass based additive qualitive functions described in the previous chapter, including Newman's Modularity, measure the deviation between the fraction of edges falling within modules and the null model. In any case though, they assess the statistical significance of this deviation.
...
Nonetheless, the size of the graphs explored numerically is quite typical of brain-connectivity networks and I feel encouraged to apply Surprise maximization to the study of the community structure of the brain.
...
Here, we describe direct maximization of Surprise by exploiting FAGSO~\cite{jiang2014} (Fast AGlomerative Surprise Optimization), an agglomerative optimization algorithm that builds on a variation of the Kruskal algorithm for minimum spanning tree~\cite{leiserson2001}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Resting state dataset}\label{sec:restingstatedataset}
