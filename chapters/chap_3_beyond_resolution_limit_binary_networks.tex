...
In this sense, it's worth noting that $S$ is a \emph{p}-value of a one-tailed Fisher exact-test where one is asking how confidently should reject the null hypothesis that the intracluster density is greater than the graph density.
