...
In humans, the fluctuations of resting-state connectivity typically exhibit the highest correlation at low temporal frequencies (<0.1 Hz) and can be observed during alertness~\cite{fox2006}, sleep~\cite{horovitz2009}, light sedation~\cite{greicius2008} and general anaesthesia~\cite{martuzzi2010}.
...
\textcolor{red}{The \emph{global definitions} are based on an interpretation of the network as a whole, of which communities are an essential part that cannot be taken away without destroying its connectivity.}\todo{FIX}
...
Whether this procedure may help obtaining a better view on the underlying structure of networks, it represents an hot debate in the literature~\cite{rubinov2010,thomas2011}.
...
\caption{Percolation analysis for two brain networks obtained from  coactivation matrix (A) and resting state matrix (B).}
\label{fig:percolation_analysis}
\end{figure}
\todo{mettere un altra immagine.}
